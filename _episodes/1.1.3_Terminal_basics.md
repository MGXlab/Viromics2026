...
## 2. Sorting by date
Sometimes you don't want files in alphabetical order. Perhaps you want to know what changed most recently (very useful once you start generating your own output files later this week).
...
> ## Solution
>
> Without `-t`, files are listed alphabetically. With `-ltrh`, they're listed oldest to newest, with the most recently modified file at the bottom. You will use this often once you're creating your own results.
> {: .source}
{: .solution}

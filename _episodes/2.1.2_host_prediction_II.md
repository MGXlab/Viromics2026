...
> 3. Does the probablility score relate to the number of genes in the contigs? You can plot these against each other using the `*Seq_Info_Prediction.tsv` file.
> 4. What is the prediction of your chosen contig? Compared with the results from VContact3, does the prediction match your expectations? Do other contigs connected to your contig also share a common host prediction?
{: .challenge}

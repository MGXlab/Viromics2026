...
# TODO
- This lesson teaches students the importance of benchmarking a tool before using it; the next lesson tells them to use an unbenchmarked tool. It also states students will test performance, but they don't benchmark, only compare with checkv. As a student i would find this hard to follow.
...
> What is the main takeaway from these figures?    
> 
> 4. Overall, which types of tools perform better? Why do you think that is?
> 
> 5. Considering all you have learned from the paper, is there an ideal tool to identify viral sequences? Why (not)?
>

...
>
> Once you are on Draco, you will start in your home directory. From there, copy over a script from `/vast/groups/VEO/shared_data/Viromics2025_workspace/setup_workspace.sbatch` location to your home directory and run it. This script will build the scaffold for all our computational work.
> 
>```bash
>
># go to home
>cd ~
>
># copy over the sbatch
>cp /vast/groups/VEO/shared_data/Viromics2025_workspace/setup_workspace.sbatch ./
>
># run the script
>sbatch setup_workspace.sbatch
>
>This script will drop you in the ./Viromics2025_workspace directory - this is where you live from now on. 
>```
> {: .source}
{: .challenge}
